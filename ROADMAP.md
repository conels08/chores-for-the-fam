...
## Stability and auth
- [ ] Confirm auth rehydration is stable on tab switch and refresh
- [ ] Remove or gate dev-only auth logs before release
- [ ] Ensure no infinite loading states across all routes

## Data integrity and security
- [ ] Review Supabase RLS policies for all tables and views
- [ ] Verify role-based permissions for admin/member/child flows
